...
/*
  ...
  4- We tamper the sequence of the resulting document by
     changing baz for bzz in action 3
*/
...
// Tamper
$pas_string_tampered = str_replace("W|F1|baz", "W|F1|baa", $pas_string_original);
